...
public class CharacterStat {
    ...
    public void encode(OutPacket packet) {
        ...
        packet.encodeBuffer(new byte[24]);// aliPetLockerSN
    ...
    public void encodeChangeStat(OutPacket packet, int flag) {
        ...
        if ((flag & CharacterStatType.HP) > 0) {
            packet.encodeInt(this.hp);
        }
        if ((flag & CharacterStatType.MHP) > 0) {
            packet.encodeInt(this.mhp);
        }
        if ((flag & CharacterStatType.MP) > 0) {
            packet.encodeInt(this.mp);
        }
        if ((flag & CharacterStatType.MMP) > 0) {
            packet.encodeInt(this.mmp);
        }
    ...
    public void encodeMoney(OutPacket packet) {
    ...
    public short getSubJob() { return subJob; }
    ...
    public void setSubJob(short subJob) { this.subJob = subJob; }

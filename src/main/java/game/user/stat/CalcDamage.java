...
public class CalcDamage {
    ...
    public void MDamage(CharacterData cd, BasicStat bs, SecondaryStat ss, MobStat ms, int damagePerMob, int weaponItemID, int action, SkillEntry skill, byte slv, List<Integer> damage, int mobCount) {
